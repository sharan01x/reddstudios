---
title: From Time-Telling to Clock-Building
subtitle: "Why the best design leaders build systems that render themselves unnecessary"
date: 17 Apr 2026
author: sharanx
tags:
  - design
  ...
  - work
  - ux
image: "from-time-telling-to-clock-building.png"
audio: "from-time-telling-to-clock-building.mp3"
---
...
1. **Social media images:** Off-the-shelf tools like ChatGPT or Claude can produce any style of images, and that's the problem. Tools like this would ensure that we can produce any image on-demand while keeping it brand-specific.
2. **PowerPoint generator:** This is not just a template, but a tool that produces the required slides and graphics for each, while also making sure the right slide templates are applied.
3. **Storyboard generator:** As a design team, we also produce a lot of videos mainly used for marketing. This process involves a lot of back and forth with the marketing team, especially at the storyboarding phase. So we built a storyboard creation tool that can create the various key scenes of the story that the marketing team wants to tell. This helps create a better brief for the design team when it comes to actual production.
